app.controller('TotalUnitsDroppedCtrl', function($scope, $state, $rootScope, $location, httpService, LS, toastr, commonFunctions, DTOptionsBuilder, DTColumnBuilder, $q) {
    commonFunctions.checkUserSession();

    $scope.Menu = {
        title: 'Dashboard',
        subtitle: 'Total Units Dropped'
    };

    $scope.authorized = false;
    $scope.totalCollectedList = {}

    httpService.sendCommand('/getTotalUnitsDropped', { actionStatusId: 10 }).then(function(result, error) {
